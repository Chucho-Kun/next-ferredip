...
import { slugToMarca, slugToCategory } from './slugs';

// Reexportados por compatibilidad: hoy viven en './slugs' (sin dependencia de la
// base de datos) para poder usarse también desde client components.
export { slugToMarca, slugToCategory };
