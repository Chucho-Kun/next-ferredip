        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <Link href={'https://www.facebook.com/Ferredip/'} target='_blank' className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition">
                <img width={25} height={25} src={'/icons/facebook.svg'} alt="facebook" />
              </Link>
              <Link href={'https://www.tiktok.com/@Ferredip_construccionlig'} target='_blank' className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition">
                <img width={25} height={25} src={'/icons/tiktok.svg'} alt="tiktok" />
              </Link>
              <Link href={'https://www.instagram.com/Ferredip_/'} target='_blank' className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition">
                <img width={25} height={25} src={'/icons/instagram.svg'} alt="instagram" />
              </Link>
              <Link href={'https://www.youtube.com/@FerredipCONSTRUCCIONLIGERA'} target='_blank' className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition">
